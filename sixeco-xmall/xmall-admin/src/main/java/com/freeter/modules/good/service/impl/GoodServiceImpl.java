...
public class GoodServiceImpl extends ServiceImpl<GoodDao, GoodEntity> implements GoodService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		Page<GoodEntity> page = this.selectPage(new Query<GoodEntity>(params).getPage(),
	...
	/*
	 * @Override public PageUtils queryGoodPage(Map<String, Object> params ) {
	 * Page<GoodEntity> page = this.selectPage( new
	 * Query<GoodEntity>(params).getPage(), new EntityWrapper<GoodEntity>() );
	 * 
	 * return new PageUtils(page); }
	 */
	...
	@Override
	public List<GoodView> getByIds(List ids, Integer page, Integer pageSize) {
