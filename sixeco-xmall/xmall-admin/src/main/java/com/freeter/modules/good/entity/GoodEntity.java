...
public class GoodEntity<T> implements Serializable {
	...
	public Map<String,Object> getOldObj(){
	    Map<String,Object> map=new HashMap <String,Object>();
	    map.put("id",this.goodId);
	    map.put("categoryId",this.categoryId);
	    map.put("productCode",this.goodNumber);
	    map.put("name",this.goodName);
	    map.put("content",this.content);
	    map.put("cover",this.picImg);
	    map.put("price",this.defaultPrice);
	    map.put("deleteFlag",this.delFlag);
	    map.put("recommendFlag",this.showInLike);
	    map.put("createTime",this.createTime);
	    map.put("createBy",this.createBy);
	    map.put("lastModifyTime",this.updateTime);
	    map.put("lastModifyBy",this.updateBy);
	    map.put("discount",this.discount);
	    map.put("inventory",this.inventory);
	    map.put("state",this.showInShelve);
	    map.put("newFlag",this.newGoodFlag);
	    map.put("sort",this.sort);
	    map.put("tip1",this.tip1);
	    map.put("tip2",this.tip2);
	    map.put("tip3",this.tip3);
	    map.put("tip4",this.tip4);
	    map.put("isRecommend",this.showInLike);
	    map.put("typeSeq",this.categoryStr);
	    map.put("isHot",this.showInHot);
	    //map.put("tags",null);
        map.put("configure",this.configureImg);
        map.put("commentsId",this.commentsIdStr);
        map.put("allowBuy",this.allowBuyFlag);
        map.put("type",this.type);
        map.put("secondKillPrice",this.activityPrice);
        map.put("inventoryOld",this.originalInventory);
        map.put("pickType",this.pickType);
        map.put("intro",this.introduce);
        map.put("supplier",this.supplier);
        return map;
    }
}
