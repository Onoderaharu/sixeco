...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '分类名称', field: 'categoryName', visible: false,align: 'center', valign: 'middle', sortable: true, width: '100px'},
	...
	methods : {
		  getMenu: function(menuId){
	            ...
	            $.get(baseURL + "good/category/getCategorylist", function(r){
	                ...
	                console.log("node--------:"+node.categoryName);
	                ztree.selectNode(node);
	                vm.category.parentName = node.categoryName;
	                console.log("vm--------:"+vm.category.parentName);
	                Vue.set(vm.category, 'parentName', node.categoryName);
        ...
        menuTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    console.log("菜单："+node[0].categoryName);
                    if(node[0].type == 2){
                    	alert("不能选择二级分类");
                    	return false;
                    }
                    ...
                    console.log("菜单树："+vm.category.parentName);
                    layer.close(index);
                }
            });
        },
